...
import { OnlineResume } from '../learning/resume'
...
export function ProfileTabContent({ onBack }: { onBack?: () => void }) {
  ...
  return (
    <>
      <div
        className="relative transition-colors duration-300 rounded-2xl overflow-hidden"
