...
import { themeList, type ThemeType, type ThemeConfig } from '../../lib/themes'
...
export function ThemeSelectorPanel({ isOpen, onClose, currentTheme, themeConfig, onThemeChange }: ThemeSelectorPanelProps) {
